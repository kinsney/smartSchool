...
<template>
	<div class="v-mapBox" v-show="isCampus"  @mousedown.stop="">
		...
		<svg version="1.1" id="图层_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		 width="200px" height="200px" viewBox="0 0 170.667 118" enable-background="new 0 0 170.667 118" xml:space="preserve">
...
<script>
	module.exports =
	{
		...
		vuex:
		{
			getters:
			{
				isCampus: ({routeSite}) => {return routeSite.scope == "campus";}
			}
		}
	}
</script>