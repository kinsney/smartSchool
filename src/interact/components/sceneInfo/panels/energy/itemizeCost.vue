	...
	module.exports =
	{
		...
		methods:
		{
			freshOption(chartData)
			{
		            ...
		            [
		                {
		                    ...
		                    [
		                        ...
		                        {name:'空调', value:44,itemStyle : labelTop}
		                    ]
		                },
		                {
		                    type : 'pie',
		                    ...
		                    [
		                        {name:'other', value:56, itemStyle : labelBottom},
		                        {name:'照明', value:44,itemStyle : labelTop}
		                    ]
		                },
		                {
		                    type : 'pie',
		                    ...
		                    [
		                        ...
		                        {name:'供暖', value:35,itemStyle : labelTop}
		                    ]
		                },
		                {
		                    type : 'pie',
		        ...
		        var options2 = 
		        {
		            color:['#fe9f79','#6ad3e8','#32B26C','#9c89ff'],
